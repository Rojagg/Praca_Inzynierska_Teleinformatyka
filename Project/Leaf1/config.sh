...
ip addr add 192.168.11.1/30 dev eth1
ip addr add 192.168.21.1/30 dev eth2
...
ip link set vrf1br address 11:22:33:44:55:66 addregenmode none
...
ip link set vlan10 addr aa:bb:cc:00:00:6e
...
ip link set vlan11 addr aa:bb:cc:00:00:6f
ip addr add 10.0.11.1/24 dev vlan20
...
ip link set vrf2br address 11:22:33:44:55:66 addregenmode none
ip link set vrf2br master vrf1
...
ip link set vlan20 addr aa:bb:cc:00:00:78
ip addr add 10.0.20.1/24 dev vlan10
...
ip link set vlan21 addr aa:bb:cc:00:00:79
ip addr add 10.0.21.1/24 dev vlan20
